...
# Check if "Player" Has "6 white_stained_glass_pane":
execute if score @s model_requirement_3 matches ..5 run scoreboard players add @s model_error 1
execute if score @s model_requirement_3 matches ..5 run tellraw @s [{"text": "[", "color": "white"},{"text": "Mr_Chibis Models", "color":"#632FF1"}, {"text": "] ", "color": "white"},{"text":"Error, you require \"6\" or more ", "color": "#A3A3A3"},{"text": "minecraft:white_stained_glass_pane.", "color": "red"}]
...
execute if score @s model_error matches 0 run clear @s minecraft:white_stained_glass_pane 6

# Grant Model:
execute if score @s model_error matches 0 run function models_admin:commands/give
execute if score @s model_error matches 0 run tellraw @s [{"text": "[", "color": "white"},{"text": "Mr_Chibis Models", "color":"#632FF1"}, {"text": "] ", "color": "white"},{"text":"Gave 1 Wooden Glass Cabinet.", "color": "green"}]