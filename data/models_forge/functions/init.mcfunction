...
# Forge GUI:
execute unless entity @e[type=block_display,tag=forge_model,tag=selected_forge_model,sort=nearest,distance=0..5] run function models_forge:tags/gui/unselected
execute if entity @e[type=block_display,tag=forge_model,tag=selected_forge_model,sort=nearest] run function models_forge:tags/gui/selected