...
execute as @e[type=minecraft:block_display,distance=0..5,sort=nearest,tag=forge_layer,tag=selected_forge_layer] at @s run tag @s remove selected_forge_layer
