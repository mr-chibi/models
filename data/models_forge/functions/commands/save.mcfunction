...
#
execute as @s[tag=saved_forged_model] as @e[type=minecraft:marker,distance=0..5,tag=forge_save_compiler,sort=nearest,limit=1] at @s store result score @s forge_total_layers if entity @e[type=minecraft:block_display,distance=0..5,tag=forge_model,sort=nearest]
execute as @s[tag=saved_forged_layer] as @e[type=minecraft:marker,distance=0..5,tag=forge_save_compiler,sort=nearest,limit=1] at @s store result score @s forge_total_layers if entity @e[type=minecraft:block_display,distance=0..5,tag=forge_layer,sort=nearest]
