...
execute as @s[scores={forge_collision=5}] as @e[type=minecraft:block_display,tag=forge_layer,distance=0..5,sort=nearest] at @s run tag @s add chain_x_collision
tellraw @s[scores={forge_collision=5}] [{"text": "[", "color": "white"},{"text": "Mr_Chibis Models", "color":"#632FF1"}, {"text": "] ", "color": "white"}, {"text": "Collision set as \"chain[axis=x]\"!", "color": "green"}]

# Add Chain Collision [y]:
execute as @s[scores={forge_collision=6}] as @e[type=minecraft:block_display,tag=forge_layer,distance=0..5,sort=nearest] at @s run tag @s add chain_y_collision
tellraw @s[scores={forge_collision=6}] [{"text": "[", "color": "white"},{"text": "Mr_Chibis Models", "color":"#632FF1"}, {"text": "] ", "color": "white"}, {"text": "Collision set as \"chain[axis=y]\"!", "color": "green"}]

# Add Chain Collision [z]:
execute as @s[scores={forge_collision=7}] as @e[type=minecraft:block_display,tag=forge_layer,distance=0..5,sort=nearest] at @s run tag @s add chain_z_collision
tellraw @s[scores={forge_collision=7}] [{"text": "[", "color": "white"},{"text": "Mr_Chibis Models", "color":"#632FF1"}, {"text": "] ", "color": "white"}, {"text": "Collision set as \"chain[axis=z]\"!", "color": "green"}]
