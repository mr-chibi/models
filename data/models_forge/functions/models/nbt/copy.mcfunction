...
#
execute as @s[tag=copied_forged_model] unless entity @e[type=minecraft:marker,distance=0..5,tag=forge_copy_compiler,sort=nearest,limit=1] as @e[type=minecraft:block_display,tag=forge_model,distance=0..5,sort=nearest,limit=1] at @s align xyz run summon minecraft:marker ~ ~ ~ {data:{layers:[]},Tags:["forge_copy_compiler","forge_entity"]}
execute as @s[tag=copied_forged_layer] unless entity @e[type=minecraft:marker,distance=0..5,tag=forge_copy_compiler,sort=nearest,limit=1] as @e[type=minecraft:block_display,tag=forge_layer,distance=0..5,sort=nearest,limit=1] at @s align xyz run summon minecraft:marker ~ ~ ~ {data:{layers:[]},Tags:["forge_copy_compiler","forge_entity"]}
