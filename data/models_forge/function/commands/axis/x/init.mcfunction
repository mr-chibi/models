...
tellraw @s[scores={forge_axis_x=..-21}] [{"text": "[", "color": "white"},{"text": "Mr_Chibis Models", "color":"#632FF1"}, {"text": "] ", "color": "white"},{"text":"Error, please modify your forge speed to resolve this issue.", "color": "red"}]

# Update Message:
tellraw @s[scores={forge_axis_x=-20..61}] [{"text": "[", "color": "white"},{"text": "Mr_Chibis Models", "color":"#632FF1"}, {"text": "] ", "color": "white"},{"text":"Updated axis X.", "color": "#A3A3A3"}]

# Reset Command:
scoreboard players set @s[scores={forge_axis_x=62..}] forge_axis_x_rclick 61
scoreboard players set @s[scores={forge_axis_x=..-20}] forge_axis_x_rclick -20
