...
tellraw @s[scores={forge_axis_y=..-21}] [{"text": "[", "color": "white"},{"text": "Mr_Chibis Models", "color":"#632FF1"}, {"text": "] ", "color": "white"},{"text":"Error, please modify your forge speed to resolve this issue.", "color": "red"}]

# Update Message:
tellraw @s[scores={forge_axis_y=-20..61}] [{"text": "[", "color": "white"},{"text": "Mr_Chibis Models", "color":"#632FF1"}, {"text": "] ", "color": "white"},{"text":"Updated axis Y.", "color": "#A3A3A3"}]

# Reset Command:
scoreboard players set @s[scores={forge_axis_y=62..}] forge_axis_y_rclick 61
scoreboard players set @s[scores={forge_axis_y=..-20}] forge_axis_y_rclick -20
