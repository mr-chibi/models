...
scoreboard objectives add forge_axis_z trigger

# [Forging Tool Scale]:
scoreboard objectives add forge_scale_x trigger
...
scoreboard objectives add forge_rotate_x trigger

# [Forging Tool Angle]:
scoreboard objectives add forge_angle_x trigger
...
# [Forging Layering]:
scoreboard objectives add forge_total_layers dummy
