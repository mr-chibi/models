...
execute if data entity @p Inventory[{id:"minecraft:redstone_lamp",tag:{Tags:["lamps_category"]}}] run data modify entity @s data.model_selected_category set value "lamps"
execute if data entity @p Inventory[{id:"minecraft:redstone_lamp",tag:{Tags:["lamps_category"]}}] run data modify entity @s data.model_page set value 1
execute if data entity @p Inventory[{id:"minecraft:redstone_lamp",tag:{Tags:["lamps_category"]}}] run function models_ui:icons/reset
