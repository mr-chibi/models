...
scoreboard players reset @s model_triad_pallete
scoreboard players reset @s model_tools
scoreboard players reset @s model_give
scoreboard players reset @s model_place
scoreboard players reset @s model_remove
scoreboard players reset @s model_sel
