...
execute align xyz run summon block_display ~ ~1 ~ {width:1f,height:1f,start_interpolation:1,interpolation_duration:3,transformation:{translation:[0f,0f,0.05f],left_rotation:[0f,0f,0f,1f],scale:[1f,1f,0.05f],right_rotation:[0f,0f,0f,1f]},billboard:"fixed",block_state:{Name:"minecraft:stripped_dark_oak_wood"}, Tags:["shelf_vertical_wall_back", "layer_2", "primary_pallete", "furniture_block", "glass_cabinet_1"]}
...
execute align xyz run summon block_display ~ ~2 ~ {width:1f,height:1f,start_interpolation:1,interpolation_duration:3,transformation:{translation:[0f,0f,0.05f],left_rotation:[0f,0f,0f,1f],scale:[1f,1f,0.05f],right_rotation:[0f,0f,0f,1f]},billboard:"fixed",block_state:{Name:"minecraft:stripped_dark_oak_wood"}, Tags:["shelf_vertical_wall_back", "layer_3", "primary_pallete", "furniture_block", "glass_cabinet_1"]}
...
execute align xyz run summon block_display ~ ~3 ~ {width:1f,height:1f,start_interpolation:1,interpolation_duration:3,transformation:{translation:[0f,0f,0.05f],left_rotation:[0f,0f,0f,1f],scale:[1f,1f,0.05f],right_rotation:[0f,0f,0f,1f]},billboard:"fixed",block_state:{Name:"minecraft:stripped_dark_oak_wood"}, Tags:["shelf_vertical_wall_back", "layer_4", "primary_pallete", "furniture_block", "glass_cabinet_1"]}
