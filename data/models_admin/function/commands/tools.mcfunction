...
clear @s minecraft:brush[minecraft:item_model="minecraft:stick",minecraft:custom_name="[{\"text\": \"Sel Brush\", \"color\": \"yellow\"}]",minecraft:lore=["{\"text\": \"Right click, to cancel current selection!\", \"color\": \"#4A6DEC\"}"]] 1
...
give @s minecraft:brush[minecraft:item_model="minecraft:stick",minecraft:custom_name="[{\"text\": \"Sel Brush\", \"color\": \"yellow\"}]",minecraft:lore=["{\"text\": \"Right click, to cancel current selection!\", \"color\": \"#4A6DEC\"}"]] 1
