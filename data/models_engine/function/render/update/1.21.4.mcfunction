...
# 
##########################################################################
execute if entity @e[type=minecraft:marker,distance=0..5,tag=forge_update_compiler,sort=nearest,limit=1] as @e[type=minecraft:marker,distance=0..5,tag=forge_update_compiler,sort=nearest,limit=1] at @s[scores={forge_total_layers=..0}] run summon minecraft:item ~ ~ ~ {Item:{components:{"minecraft:custom_name":'{"color":"aqua","text": "Updated V3.0 Forge Model"}',"minecraft:lore":[{"text": "Right click, to place your creation!", "color": "#4A6DEC"},  {"text": ""}, {"text": "Updated Model, 'forge_model' ", "color": "#A3A3A3"},  {"text": "Version: 1.21.4", "color": "aqua"}, ],"custom_data":{model_id:"forge_model", layers:[], sprites:[], sprite_frame:0, Tags:["forge_save_model"], forge_spawn_egg:1b},"minecraft:entity_data":{id:"minecraft:marker", Tags:["forge_paste_compiler"]}}, id: "minecraft:allay_spawn_egg"}}
...
execute if entity @e[type=minecraft:marker,distance=0..5,tag=forge_update_compiler,sort=nearest,limit=1] as @e[type=minecraft:marker,distance=0..5,tag=forge_update_compiler,sort=nearest,limit=1] at @s[scores={forge_total_layers=..0}] run tag @p remove model_1.21.4
