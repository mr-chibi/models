...
###########################################################
execute as @s[y_rotation=135..-135] if entity @e[type=minecraft:marker,tag=forge_paste_compiler,distance=0..5,sort=nearest,limit=1] as @e[type=minecraft:marker,distance=0..5,tag=forge_paste_compiler,sort=nearest,limit=1] at @s if score @s model_render = max model_render align xyz run summon minecraft:block_display ~ ~ ~ {Tags:["forge_layer"],Rotation:[360f,0f],data:{"sprite_rotation":[],"sprite_frame":0,"sprite_sound_frame_1":0,"sprite_sound_1":"","sprite_sound_pitch_1":0,"sprite_sound_frame_2":0,"sprite_sound_2":"","sprite_sound_pitch_2":0,"sprite_collision":"","sprite_collision_frame":0,"sprite_fps":20}}
execute as @s[y_rotation=-135..-45] if entity @e[type=minecraft:marker,tag=forge_paste_compiler,distance=0..5,sort=nearest,limit=1] as @e[type=minecraft:marker,distance=0..5,tag=forge_paste_compiler,sort=nearest,limit=1] at @s if score @s model_render = max model_render align xyz run summon minecraft:block_display ~1 ~ ~ {Tags:["forge_layer"],Rotation:[90f,0f],data:{"sprite_rotation":[],"sprite_frame":0,"sprite_sound_frame_1":0,"sprite_sound_1":"","sprite_sound_pitch_1":0,"sprite_sound_frame_2":0,"sprite_sound_2":"","sprite_sound_pitch_2":0,"sprite_collision":"","sprite_collision_frame":0,"sprite_fps":20}}
execute as @s[y_rotation=-45..45] if entity @e[type=minecraft:marker,tag=forge_paste_compiler,distance=0..5,sort=nearest,limit=1] as @e[type=minecraft:marker,distance=0..5,tag=forge_paste_compiler,sort=nearest,limit=1] at @s if score @s model_render = max model_render align xyz run summon minecraft:block_display ~1 ~ ~1 {Tags:["forge_layer"],Rotation:[180f,0f],data:{"sprite_rotation":[],"sprite_frame":0,"sprite_sound_frame_1":0,"sprite_sound_1":"","sprite_sound_pitch_1":0,"sprite_sound_frame_2":0,"sprite_sound_2":"","sprite_sound_pitch_2":0,"sprite_collision":"","sprite_collision_frame":0,"sprite_fps":20}}
execute as @s[y_rotation=45..135] if entity @e[type=minecraft:marker,tag=forge_paste_compiler,distance=0..5,sort=nearest,limit=1] as @e[type=minecraft:marker,distance=0..5,tag=forge_paste_compiler,sort=nearest,limit=1] at @s if score @s model_render = max model_render align xyz run summon minecraft:block_display ~ ~ ~1 {Tags:["forge_layer"],Rotation:[270f,0f],data:{"sprite_rotation":[],"sprite_frame":0,"sprite_sound_frame_1":0,"sprite_sound_1":"","sprite_sound_pitch_1":0,"sprite_sound_frame_2":0,"sprite_sound_2":"","sprite_sound_pitch_2":0,"sprite_collision":"","sprite_collision_frame":0,"sprite_fps":20}}
...
#
execute if entity @e[type=minecraft:marker,tag=forge_paste_compiler,distance=0..5,sort=nearest,limit=1] as @e[type=minecraft:marker,distance=0..5,tag=forge_paste_compiler,sort=nearest,limit=1] at @s if score @s model_render = max model_render as @e[type=minecraft:block_display,tag=forge_layer,distance=0..5,sort=nearest,tag=!forge_layer_added,limit=1] at @s run data modify entity @s data.sprite_rotation set from entity @e[type=minecraft:marker,tag=forge_paste_compiler,distance=0..5,sort=nearest,limit=1] data.sprite_rotation
