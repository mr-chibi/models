...
# Collision Scale X 2, Y -1:
execute if entity @s[y_rotation=135..-135,scores={forge_collision_width=2,forge_collision_height=-1}] if block ~-2 ~ ~-1 minecraft:air run fill ~-2 ~-1 ~-1 ~-1 ~-1 ~-1 minecraft:air
execute if entity @s[y_rotation=-135..-45,scores={forge_collision_width=2,forge_collision_height=-1}] if block ~ ~ ~-2 minecraft:air run fill ~ ~-1 ~-1 ~ ~-1 ~-2 minecraft:air
execute if entity @s[y_rotation=-45..45,scores={forge_collision_width=2,forge_collision_height=-1}] if block ~ ~ ~2 minecraft:air run fill ~ ~-1 ~-1 ~1 ~-1 ~0 minecraft:air
execute if entity @s[y_rotation=45..135,scores={forge_collision_width=2,forge_collision_height=-1}] if block ~-2 ~ ~ minecraft:air run fill ~-1 ~-1 ~1 ~-1 ~-1 ~ minecraft:air
