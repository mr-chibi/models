...
execute if entity @e[type=minecraft:marker,distance=0..5,tag=forge_update_compiler,sort=nearest,limit=1] as @e[type=minecraft:marker,distance=0..5,tag=forge_update_compiler,sort=nearest,limit=1] at @s[scores={forge_total_layers=..0}] run tag @p remove model_1.20.4
