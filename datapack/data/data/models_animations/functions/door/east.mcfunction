...
#
execute as @s[scores={model_keyframes=1..17}] align xyz run fill ~ ~ ~ ~ ~1 ~ minecraft:air
execute as @s[scores={model_keyframes=5}] run playsound minecraft:block.fence_gate.open master @a[distance=0..20] ~ ~ ~ 1 0.5

#
execute as @s[scores={model_keyframes=35..51}] align xyz run fill ~ ~ ~ ~ ~1 ~ minecraft:barrier
